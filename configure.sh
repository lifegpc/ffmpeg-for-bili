...
./configure \
    ...
    --disable-hwaccels \
    --disable-demuxers \
    --enable-demuxer=ass,flac,hls,image_bmp_pipe,image_jpeg_pipe,image_jpegls_pipe,image_png_pipe,image_webp_pipe,matroska,mjpeg,mjepg_2000,mov,mpegts,srt,webvtt \
    --disable-muxers \
